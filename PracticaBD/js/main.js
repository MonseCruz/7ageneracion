const saveProductToDb = (productObject)=>{
    ...
    xhttp.open("POST","https://javascript-ajax-d0ce6.firebaseio.com/raquel/products.json",true)
...
const putProduct = (productId,productObject) => {
    ...
    xhttp.open("PUT",`https://javascript-ajax-d0ce6.firebaseio.com/raquel/products/${productId}.json`,true)
...
const deleteProduct = (productId) => {
    ...
    xhttp.open("DELETE",`https://javascript-ajax-d0ce6.firebaseio.com/raquel/koders/${productId}.json`,true)
    xhttp.send()
}